...
def resolve_eigdirs(args):
    if args.eigdir is not None:
        ...
        # set default eigroot if not provided
...
def main():
    ...
    # --- Build protein-heavy and Cα views ---
    protein_heavy_traj, protein_heavy_top, protein_heavy_idx_local, protein_heavy_idx_full, top_xtc_full = build_protein_heavy_views(pdb_code)

    # C-alpha indices (within protein-heavy topology)
